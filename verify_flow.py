...
def safe_print(text):
    try:
        ...
        # Fallback to ascii representation for unsupported terminal encodings
...
def verify():
    ...
    try:
        ingest_res = send_post("/api/v1/customers/ingest", mock_data)
    ...
    try:
        recommendation = send_post("/api/v1/campaigns/recommend", {"prompt": prompt})
    ...
    while time.time() - start_time < 30:
        campaigns = send_get("/api/v1/campaigns/")
